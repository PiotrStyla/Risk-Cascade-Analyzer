...
class TestHROnboardingDataBreachScenario(unittest.TestCase):
    def test_scenario_builds_and_runs(self):
        scenario = SCENARIO_LIBRARY.get_scenario("hr_onboarding_data_breach")
        ...
        breach_prob = inference.compute_risk_score(evidence, "tech_data_breach", "occurred")
